...
export class MyApp {
  ...
  constructor(public platform: Platform, public statusBar: StatusBar, public splashScreen: SplashScreen) {
    ...
    this.pages = [
      { title: 'Obituary', component: ObituaryPage },
       { title: 'Appreciation', component: AppreciationPage },
       { title: 'Memorials', component: MemorialsPage },
        { title: 'Login', component: LoginPage },
         { title: 'Payment', component: LoginPage }
    ];
